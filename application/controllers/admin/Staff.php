...
class Staff extends Admin_Controller
{
    ...
    public function pdf($id)
    {
       ...
       $html = $this->load->view('admin/staff/staffpdf', array('enable_disable'=> $data['enable_disable'],'id'=> $data['id']
       ,'title'=> $data['title'] 
       ,'timeline_list'=> $data['timeline_list']
       ,'sch_setting'=> $data['sch_setting']
       ,'staffid_auto_insert'=> $data['staffid_auto_insert']
       ,'attendencetypeslist'=> $data['attendencetypeslist']
       ,'leavedetails'=> $data['leavedetails']
       ,'staff_leaves'=> $data['staff_leaves']
       ,'staff_doc_id'=> $data['staff_doc_id']
       ,'staff'=> $data['staff']
       ,'staff_payroll'=> $data['staff_payroll']
       ,'salary'=> $data['salary']
       ,'monthlist'=> $data['monthlist']
       ,'yearlist'=> $data['yearlist']
       ,'rate_canview'=> $data['rate_canview']
       ,'reviews'=> $data['reviews']
       ,'reviews_comment'=> $data['reviews_comment']
       ,'user_reviewlist'=> $data['user_reviewlist']
       ,'countAttendance'=> $data['countAttendance']
