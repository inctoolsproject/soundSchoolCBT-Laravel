...
class Student extends Admin_Controller
{
    ...
    public function pdf($id)
    {
        ...
        // $this->load->view('student/studentshowpdf',$data);
        
        $html = $this->load->view('student/studentshowpdf', array('title'=> $data['title'],'timeline_list'=> $data['timeline_list']
        ,'sch_setting'=> $data['sch_setting'] 
        ,'adm_auto_insert'=> $data['adm_auto_insert']
        ,'session'=> $data['session']
        ,'student_discount_fee'=> $data['student_discount_fee']
        ,'student_due_fee'=> $data['student_due_fee']
        ,'student_doc'=> $data['student_doc']
        ...
        ,'studentlistbysection'=> $data['studentlistbysection']
        ,'guardian_credential'=> $data['guardian_credential']
        ,'reason'=> $data['reason']
        ,'reason_data'=> $data['reason_data']
        ,'exam_result'=> $data['exam_result']
        ,'exam_grade'=> $data['exam_grade'] ) ,true);
