                ...
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="row">
                                    <form role="form" action="<?php echo site_url('studentfee/voucherTrack') ?>" method="post" class="">
                            ...
                            <div class="col-md-6">
                                <div class="row">
                                    <form role="form" action="<?php echo site_url('studentfee/voucherTrack') ?>" method="post" class="">
                                        ...
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                <label>Enter id</label><small class="req"> *</small>
                                                <input autofocus="" type="text"  name="id"  class="form-control" placeholder="Search by Id">
